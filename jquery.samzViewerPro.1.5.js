...
*/
/*! from user
* Thank Gian Carlo Mingati for sharing your valuable work under  MIT and GPL licenses
* em Sameer
*/
...
var j = 0;
jQuery.fn.SamzSliding = function (settings) {
    ...
    .wrap(jQuery("<div style='width:" + pictWidth + "px; overflow: hidden; position: relative; top: 0; left: 0'>"));
        ...
        container.each(function (i) {
            ...
            // Samz added: style='border:solid 1px #ccc;'
            ...
            jQuery("div#thumbSlider" + j + " a").each(function (z) {
                jQuery(this).bind("click", function () {
                    ...
                    //Setting slide to continue running after thumb clicked iii
                    //$("div#tval").text(' clicked ' + _numclicked);
                    if (_clicked == true) { _numclicked = z; _clicked = false; }
                    //end Set...
            ...
            if (settings.autoslide) {
                ...
                jQuery("div#thumbSlider" + j).everyTime(settings.asTimer, "asld", function () {
                    ...
                    //Setting slide to continue running after thumb clicked - ii
                    //$("div#rval").text('clicked is ' + _numclicked + ' and i = ' + i + ' and thumb =' + i);
                    if (_numclicked != -1) { i = _numclicked;_numclicked = -1; }
                    //end Set...
                ...
                jQuery("div#thumbSlider" + j + " a").bind("mouseup", function () {
                    ...
                    //Setting slide to continue running after thumb clicked - i
                    _clicked = true;
                    //end Set...
                });
            }
